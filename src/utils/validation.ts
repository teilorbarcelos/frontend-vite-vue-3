 ...
 */
export const getRolePermissions = (role: { permissions?: unknown[] } | null | undefined): unknown[] => {
  if (!role) return [];
 ...
 */
export const formatDateRange = (name: string, from: Date, to?: Date | null): Record<string, string> => {
